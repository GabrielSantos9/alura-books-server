...
function insereFavorito(id) {
  ...
  const livroInserido = livro.find(livro => livro.id === id) //Find: encontrar elementos dentro de uma lista. Essa constante serve para encontrar livros iguais  ao id recebido, retornará o livro que será inserido
